...
{           Demo                                                               }
{                                                                              }
{           Copyright (C) Marcelo Rocha                                        }
{                                                                              }
{           https://github.com/CyberRocha/Principal                            }
{                                                                              }
{                                                                              }
{******************************************************************************}
unit Principal;
...
var ArquivoSom : String;
begin
  ArquivoSom := ExtractFileDir(ParamStr(0)) + '/Sounds/' + 'Helicoptero.mp3';
  if FileExists(ArquivoSom) then
  begin
    MediaPlayerHelicoptero.FileName := ArquivoSom;
